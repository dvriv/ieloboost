...
#wp-auth-check-wrap.hidden{display:none}#wp-auth-check-wrap #wp-auth-check-bg{position:fixed;top:0;bottom:0;left:0;right:0;background:#000;opacity:.7;filter:alpha(opacity=70);z-index:1000010}#wp-auth-check-wrap #wp-auth-check{position:fixed;left:50%;overflow:hidden;top:40px;bottom:20px;max-height:415px;width:380px;margin:0 0 0 -190px;padding:30px 0 0;background-color:#f1f1f1;z-index:1000011;-webkit-box-shadow:0 3px 6px rgba(0,0,0,.3);box-shadow:0 3px 6px rgba(0,0,0,.3)}@media screen and (max-width:380px){#wp-auth-check-wrap #wp-auth-check{left:0;width:100%;margin:0}}#wp-auth-check-wrap.fallback #wp-auth-check{max-height:180px;overflow:auto}#wp-auth-check-wrap #wp-auth-check-form{height:100%;position:relative;overflow:auto;-webkit-overflow-scrolling:touch}#wp-auth-check-form.loading:before{content:"";display:block;width:20px;height:20px;position:absolute;left:50%;top:50%;margin:-10px 0 0 -10px;background:url(../wp-includes/images/spinner.gif) center no-repeat;-webkit-background-size:20px 20px;background-size:20px 20px;-webkit-transform:translateZ(0);transform:translateZ(0)}@media print,(-webkit-min-device-pixel-ratio:1.25),(min-resolution:120dpi){#wp-auth-check-form.loading:before{background-image:url(../wp-includes/images/spinner-2x.gif)}}#wp-auth-check-wrap #wp-auth-check-form iframe{height:98%;width:100%}#wp-auth-check-wrap .wp-auth-check-close{position:absolute;top:5px;right:5px;height:22px;width:22px;color:#72777c}#wp-auth-check-wrap .wp-auth-check-close:before{content:"\f158";font:400 20px/22px dashicons;speak:none;-webkit-font-smoothing:antialiased!important;-moz-osx-font-smoothing:grayscale}#wp-auth-check-wrap .wp-auth-check-close:focus,#wp-auth-check-wrap .wp-auth-check-close:hover{color:#0073aa}#wp-auth-check-wrap .wp-auth-fallback-expired{outline:0}#wp-auth-check-wrap .wp-auth-fallback{font-size:14px;line-height:21px;padding:0 25px;display:none}#wp-auth-check-wrap.fallback .wp-auth-check-close,#wp-auth-check-wrap.fallback .wp-auth-fallback{display:block}
 ...
 */
 ...
 #wpcontent {
   max-width: 100%; margin: 0 !important; padding: 0;
  }
 #wpbody, .ait-easy-admin-wrap {
   height: auto; max-width: 100%; padding: 0 20px; margin: 0 0 0 200px !important;
 }
 .ait-easy-admin-wrap {
    padding: 0;
   }
 ...
 #posts-filter .tablenav .view-switch {
   display: none;
  }
 ...
 #posts-filter .row-actions .inline {
   display: none;
 }
 #content {
   width: auto;
 ...
 header#header ul li a:hover, header#header ul li a i:hover {
   color: #fff;
 }
 ...
 div#profile-page input {
     border: 1px solid #ddd;
 }
 div#current_order_details {
     padding: 10px;
     background-color: #fff;
     min-height: 55px;
 ...
 div#user_details_fillup{margin-top: 0.5em;}
 .user-name {
     float: left;
     padding: 7px 0;
 }
 ...
 #current_order_details .admin-info{ overflow: hidden; padding-left: 20px;}
 .wp-core-ui .profile_link .btn-primary{ min-height: 35px;}
 .wrap-custom {border: 1px solid #E6E6E6;}
 table.form-table.widefat.fixed h3 {margin: 0;}
 div#sidebar {
     padding: 0;
 ...
 /*********************Prefered Champions Reveal************** */

 img.champion_images {
   border: 2px solid #000;
 }

 label img.champion_images {
   opacity: .50;
 }

 #prefered_champions_lists {
   width: 1200px;
 }

 #prefered_champions_lists label {
   margin: .5em .5em;
   position: relative;
 }

 #prefered_champions_lists label:hover img.champion_images {
   opacity: 1;
 }

 input[type=checkbox][class=champion_checkbox] {
    position: absolute;
    top: -9999px;
    left: -9999px;
 }
 input[type=checkbox][class=champion_checkbox]:checked + label {

 }

 input[type=checkbox][class=champion_checkbox]:checked + label > img {
 ...
 input[type=checkbox][class=champion_checkbox]:checked + label > i {
   display: block !important;
 }


 #prefered_champions_lists i {
   display: none;
   font-size: 3em;
   position: absolute;;
   cursor: pointer;
  ...
  /*********************Prefered Champions (No Reveal)************** */
 .selected_champion_container:hover img.champion_images {
   opacity: 0.5;
   cursor: pointer;
 }

 .selected_champion_container i {
   display: none;
   font-size: 3em;
   position: absolute;;
   cursor: pointer;
 ...
 .selected_champion_container:hover i {
   display: block;
 }


 .selected_champion_container {
   display: inline-block;
   position: relative;
   margin: .25em
 }
 ...
 .close-button {
   position:absolute;color:#8a8a8a;right:1rem;top:.5rem;font-size:2em;line-height:1;cursor:pointer
 }
 .api_error {
     display: inline-block;
     line-height: 19px;
 ...
 .match-history tr.matches_tr:nth-of-type(1n+6) {
   display: none;
 }
 ...
 .message-history .message-head h4 {
   padding: 0;
   margin: 0;
   display: inline-block;
 }
 ...
 .standing_block.three_col {
   display: inline-block;
   width: 32%;
   vertical-align: top;
   margin: 0 auto;
 }
 .standing_block.two_col {
   display: inline-block;
   width: 48%;
   vertical-align: top;
   margin: 0 auto;
 }
 .order_start_block .title, .order_current_block .title, .order_desired_block .title {
   text-align: center;
   font-size: 16px;
   font-weight: bold;
 }
 .order_start_details, .order_current_details, .order_desired_details {
   text-align: center;
 }
 .order_current_details .stat, .order_desired_details .stat {
   font-size: 3rem;
   padding: 40px 0;
 }
 ...
 div.match-history tbody tr.lost {
   background-color: #E4A4A4;
   border-bottom: 1px solid #C27474;
 }

 div.match-history tbody tr.win {
   background-color: #A4E4B4;
   border-bottom: 1px solid #5BA36D;
 }
 ...
 div.modal-container-tip-booster form button {
   background: #2196f3;
 }
 ...
 form.paypal-donation .btn-primary {
 ...
 .alert-container {
   ...
   box-shadow: -10px 12px 83px -25px rgba(0,0,0,0.75);
 ...
 @media screen and (max-width: 1024px) { .main-message{ margin: 0 0 10px; height: auto; max-height: 700px;}}
 @media screen and (max-width: 767px) {

 	div#mainstage, div#sidebar{
 	    width: 100%;
 	    margin: 0 0 20px;
 	    padding: 0;
 	}
 ...
 @media screen and (max-width: 667px) {
 	header#header ul li:first-child{ border-top: none;}
 	header#header ul li:last-child{ border-bottom: none;}
...
<body class="wp-admin wp-core-ui no-js  toplevel_page_my-dashboard auto-fold admin-bar branch-4-6 version-4-6-1 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<ul id="adminmenu">
	...
	<a href='#' class="wp-first-item wp-not-current-submenu menu-top menu-top-first menu-icon-dashboard menu-top-last" ><div class="wp-menu-arrow"><div></div></div><div class='wp-menu-image dashicons-before dashicons-dashboard'><br /></div><div class='wp-menu-name'>Dashboard</div></a></li>
	<li class="wp-not-current-submenu wp-menu-separator" aria-hidden="true"><div class="separator"></div></li>
	<li class="current menu-top toplevel_page_my-dashboard menu-top-first menu-top-last" id="toplevel_page_my-dashboard">
	<a href='#' class="current menu-top toplevel_page_my-dashboard menu-top-first menu-top-last" ><div class="wp-menu-arrow"><div></div></div><div class='wp-menu-image dashicons-before dashicons-groups'><br /></div><div class='wp-menu-name'>Dashboard</div></a></li>
	<li class="wp-not-current-submenu wp-menu-separator" aria-hidden="true"><div class="separator"></div></li>
	<li class="wp-not-current-submenu menu-top menu-icon-users menu-top-first menu-top-last" id="menu-users">
	<a href='#' class="wp-not-current-submenu menu-top menu-icon-users menu-top-first menu-top-last" ><div class="wp-menu-arrow"><div></div></div><div class='wp-menu-image dashicons-before dashicons-admin-users'><br /></div><div class='wp-menu-name'>Profile</div></a></li><li id="collapse-menu" class="hide-if-no-js"><div id="collapse-button"><div></div></div><span>Collapse menu</span></li></ul>
</div>
</div>
<div id="wpcontent">
       ...
       <style >
		...
		<li id="wp-admin-bar-wp-logo" class="menupop"><a class="ab-item" aria-haspopup="true" href="http://ieloboost.com/wp-admin/about.php"><span class="ab-icon"></span><span class="screen-reader-text">About WordPress</span></a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-wp-logo-default" class="ab-submenu">
		<li id="wp-admin-bar-about"><a class="ab-item" href="http://ieloboost.com/wp-admin/about.php">About WordPress</a>		</li></ul><ul id="wp-admin-bar-wp-logo-external" class="ab-sub-secondary ab-submenu">
		<li id="wp-admin-bar-wporg"><a class="ab-item" href="https://wordpress.org/">WordPress.org</a>		</li>
		<li id="wp-admin-bar-documentation"><a class="ab-item" href="https://codex.wordpress.org/">Documentation</a>		</li>
		<li id="wp-admin-bar-support-forums"><a class="ab-item" href="https://wordpress.org/support/">Support Forums</a>		</li>
		<li id="wp-admin-bar-feedback"><a class="ab-item" href="https://wordpress.org/support/forum/requests-and-feedback">Feedback</a>		</li></ul></div>		</li>
		<li id="wp-admin-bar-site-name" class="menupop"><a class="ab-item" aria-haspopup="true" href="http://ieloboost.com/">iEloboost</a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-site-name-default" class="ab-submenu">
		<li id="wp-admin-bar-view-site"><a class="ab-item" href="http://ieloboost.com/">Visit Site</a>		</li></ul></div>		</li>
		<li id="wp-admin-bar-wplc_ma_online_agents"><div class="ab-item ab-empty-item"><span class="wplc_circle wplc_red_circle"></span>0 Chat Agents Online</div>		</li></ul><ul id="wp-admin-bar-top-secondary" class="ab-top-secondary ab-top-menu">
		<li id="wp-admin-bar-my-account" class="menupop with-avatar"><a class="ab-item" aria-haspopup="true" href="http://ieloboost.com/wp-admin/profile.php">Howdy, clientekhor5<img alt='' src='http://1.gravatar.com/avatar/7022abf9220f647edb15e099f9169ac6?s=26&#038;d=mm&#038;r=g' srcset='http://1.gravatar.com/avatar/7022abf9220f647edb15e099f9169ac6?s=52&amp;d=mm&amp;r=g 2x' class='avatar avatar-26 photo' height='26' width='26' /></a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-user-actions" class="ab-submenu">
		<li id="wp-admin-bar-user-info"><a class="ab-item" tabindex="-1" href="http://ieloboost.com/wp-admin/profile.php"><img alt='' src='http://1.gravatar.com/avatar/7022abf9220f647edb15e099f9169ac6?s=64&#038;d=mm&#038;r=g' srcset='http://1.gravatar.com/avatar/7022abf9220f647edb15e099f9169ac6?s=128&amp;d=mm&amp;r=g 2x' class='avatar avatar-64 photo' height='64' width='64' /><span class='display-name'>clientekhor5</span></a>		</li>
		<li id="wp-admin-bar-edit-profile"><a class="ab-item" href="http://ieloboost.com/wp-admin/profile.php">Edit My Profile</a>		</li>
		<li id="wp-admin-bar-logout"><a class="ab-item" href="http://ieloboost.com/wp-login.php?action=logout&#038;_wpnonce=25b0d82a82">Log Out</a>		</li></ul></div>		</li></ul>			</div>
						<a class="screen-reader-shortcut" href="http://ieloboost.com/wp-login.php?action=logout&#038;_wpnonce=25b0d82a82">Log Out</a>
					</div>


<header id="header">
	<ul>
		<li><a href="/"><i class="dashicons dashicons-admin-home" aria-hidden="true"></i><span>Home</span></a></li>
		<li><a href="" class="-primary"> <i class="dashicons dashicons-dashboard" aria-hidden="true"></i><span>Dashboard</span></a></li>
		<li><a href="" class=""> <i class="dashicons dashicons-admin-users" aria-hidden="true"></i><span>My Account</span></a></li>
		<li><a href=""><i class="dashicons dashicons-share-alt2" aria-hidden="true"></i><span>Logout</span></a></li>
	</ul>
</header>
...
<div id="wpbody-content" aria-label="Main content" tabindex="0">
		<div id="screen-meta" class="metabox-prefs">
          ...
          <div class="alert callout alert-container" data-closable="">
          		  ...
          		  <p>Some functions are disabled.</p>
          		  <button class="close-button" aria-label="Dismiss alert" type="button" data-close="">
          		    <span aria-hidden="true">×</span>
          		  </button>
          		</div>

	<!-- Screen icons are no longer used as of WordPress 3.8. -->	<h2>My Dashboard</h2>
		<!-- ======== START PAGE CONTENT =========== -->
	<div id="mainstage">
		<div id="current_order_details" class="clearfix">
			<div class="avatar-image">
			  			      <img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/avatar.png" class="avatar" width="100px" alt="">
			  			</div>
				...
				<div class="row">
						...
						<form name="order_status_change_form" method="POST">
							...
							<button class="button btn-primary" type="submit">Start Order</button>
						</form>
				    </div>
									</div>
			</div>
		...
		<div id="advanced-sortables" class="meta-box-sortables"><div id="user_details_fillup_meta_box" class="postbox " >
<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Current Order Details</span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class='hndle'><span>Current Order Details</span></h2>
<div class="inside">
	  ...
	  <form name="user_details_fillup" action="" method="post">
			  ...
			  <input type="text" name="summoner_name"  value=""/>
		  </fieldset>
		  		  <fieldset>
			  ...
			  <input type="text" name="booster_notes"  value=""/>
		  </fieldset>
		  <fieldset>
			  <label for="prefered_position">Prefered Position</label>
			  			  <input type="checkbox" name="prefered_positions[]" id="radioTop" value="Top" checked /><label for="radioTop">Top</label>
			  <input type="checkbox" name="prefered_positions[]" id="radioJungle" value="Jungle" checked /><label for="radioJungle">Jungle</label>
			  <input type="checkbox" name="prefered_positions[]" id="radioMid" value="Mid"  /><label for="radioMid">Mid</label>
			  <input type="checkbox" name="prefered_positions[]" id="radioSupport" value="Support"  /><label for="radioSupport">Support</label>
			  <input type="checkbox" name="prefered_positions[]" id="radioBot" value="Bot"  /><label for="radioBot">Bot</label>
		  </fieldset>
		  <fieldset>
			  <label for="prefered_position">Prefered Champions</label>
			  <div id="selected_champions">
				  <div class='selected_champion_container'> <img data-id='7' class='champion_images' src='http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/7.png'/><i class='dashicons dashicons-no'></i></div><div class='selected_champion_container'> <img data-id='58' class='champion_images' src='http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/58.png'/><i class='dashicons dashicons-no'></i></div><div class='selected_champion_container'> <img data-id='236' class='champion_images' src='http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/236.png'/><i class='dashicons dashicons-no'></i></div><input type='hidden' name='selected_champions' value='7,58,236'>			  </div>
				...
				<div class="reveal" id="prefered_champions_lists" data-reveal data-animation-in="fade-in" >
					...
					<legend>Choose Champions</legend>
												<input id="champion1" class="champion_checkbox" type="checkbox">
								<label for="champion1"><img data-id="1" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/1.png"/></label>
													<input id="champion2" class="champion_checkbox" type="checkbox">
								<label for="champion2"><img data-id="2" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/2.png"/></label>
													<input id="champion3" class="champion_checkbox" type="checkbox">
								<label for="champion3"><img data-id="3" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/3.png"/></label>
													<input id="champion4" class="champion_checkbox" type="checkbox">
								<label for="champion4"><img data-id="4" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/4.png"/></label>
													<input id="champion5" class="champion_checkbox" type="checkbox">
								<label for="champion5"><img data-id="5" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/5.png"/></label>
													<input id="champion6" class="champion_checkbox" type="checkbox">
								<label for="champion6"><img data-id="6" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/6.png"/></label>
													<input id="champion7" class="champion_checkbox" type="checkbox">
								<label for="champion7"><img data-id="7" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/7.png"/></label>
													<input id="champion8" class="champion_checkbox" type="checkbox">
								<label for="champion8"><img data-id="8" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/8.png"/></label>
													<input id="champion9" class="champion_checkbox" type="checkbox">
								<label for="champion9"><img data-id="9" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/9.png"/></label>
													<input id="champion10" class="champion_checkbox" type="checkbox">
								<label for="champion10"><img data-id="10" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/10.png"/></label>
													<input id="champion11" class="champion_checkbox" type="checkbox">
								<label for="champion11"><img data-id="11" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/11.png"/></label>
													<input id="champion12" class="champion_checkbox" type="checkbox">
								<label for="champion12"><img data-id="12" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/12.png"/></label>
													<input id="champion13" class="champion_checkbox" type="checkbox">
								<label for="champion13"><img data-id="13" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/13.png"/></label>
													<input id="champion14" class="champion_checkbox" type="checkbox">
								<label for="champion14"><img data-id="14" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/14.png"/></label>
													<input id="champion15" class="champion_checkbox" type="checkbox">
								<label for="champion15"><img data-id="15" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/15.png"/></label>
													<input id="champion16" class="champion_checkbox" type="checkbox">
								<label for="champion16"><img data-id="16" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/16.png"/></label>
													<input id="champion17" class="champion_checkbox" type="checkbox">
								<label for="champion17"><img data-id="17" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/17.png"/></label>
													<input id="champion18" class="champion_checkbox" type="checkbox">
								<label for="champion18"><img data-id="18" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/18.png"/></label>
													<input id="champion19" class="champion_checkbox" type="checkbox">
								<label for="champion19"><img data-id="19" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/19.png"/></label>
													<input id="champion20" class="champion_checkbox" type="checkbox">
								<label for="champion20"><img data-id="20" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/20.png"/></label>
													<input id="champion21" class="champion_checkbox" type="checkbox">
								<label for="champion21"><img data-id="21" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/21.png"/></label>
													<input id="champion22" class="champion_checkbox" type="checkbox">
								<label for="champion22"><img data-id="22" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/22.png"/></label>
													<input id="champion23" class="champion_checkbox" type="checkbox">
								<label for="champion23"><img data-id="23" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/23.png"/></label>
													<input id="champion24" class="champion_checkbox" type="checkbox">
								<label for="champion24"><img data-id="24" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/24.png"/></label>
													<input id="champion25" class="champion_checkbox" type="checkbox">
								<label for="champion25"><img data-id="25" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/25.png"/></label>
													<input id="champion26" class="champion_checkbox" type="checkbox">
								<label for="champion26"><img data-id="26" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/26.png"/></label>
													<input id="champion27" class="champion_checkbox" type="checkbox">
								<label for="champion27"><img data-id="27" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/27.png"/></label>
													<input id="champion28" class="champion_checkbox" type="checkbox">
								<label for="champion28"><img data-id="28" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/28.png"/></label>
													<input id="champion29" class="champion_checkbox" type="checkbox">
								<label for="champion29"><img data-id="29" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/29.png"/></label>
													<input id="champion30" class="champion_checkbox" type="checkbox">
								<label for="champion30"><img data-id="30" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/30.png"/></label>
													<input id="champion31" class="champion_checkbox" type="checkbox">
								<label for="champion31"><img data-id="31" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/31.png"/></label>
													<input id="champion32" class="champion_checkbox" type="checkbox">
								<label for="champion32"><img data-id="32" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/32.png"/></label>
													<input id="champion33" class="champion_checkbox" type="checkbox">
								<label for="champion33"><img data-id="33" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/33.png"/></label>
													<input id="champion34" class="champion_checkbox" type="checkbox">
								<label for="champion34"><img data-id="34" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/34.png"/></label>
													<input id="champion35" class="champion_checkbox" type="checkbox">
								<label for="champion35"><img data-id="35" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/35.png"/></label>
													<input id="champion36" class="champion_checkbox" type="checkbox">
								<label for="champion36"><img data-id="36" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/36.png"/></label>
													<input id="champion37" class="champion_checkbox" type="checkbox">
								<label for="champion37"><img data-id="37" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/37.png"/></label>
													<input id="champion38" class="champion_checkbox" type="checkbox">
								<label for="champion38"><img data-id="38" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/38.png"/></label>
													<input id="champion39" class="champion_checkbox" type="checkbox">
								<label for="champion39"><img data-id="39" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/39.png"/></label>
													<input id="champion40" class="champion_checkbox" type="checkbox">
								<label for="champion40"><img data-id="40" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/40.png"/></label>
													<input id="champion41" class="champion_checkbox" type="checkbox">
								<label for="champion41"><img data-id="41" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/41.png"/></label>
													<input id="champion42" class="champion_checkbox" type="checkbox">
								<label for="champion42"><img data-id="42" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/42.png"/></label>
													<input id="champion43" class="champion_checkbox" type="checkbox">
								<label for="champion43"><img data-id="43" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/43.png"/></label>
													<input id="champion44" class="champion_checkbox" type="checkbox">
								<label for="champion44"><img data-id="44" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/44.png"/></label>
													<input id="champion45" class="champion_checkbox" type="checkbox">
								<label for="champion45"><img data-id="45" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/45.png"/></label>
													<input id="champion48" class="champion_checkbox" type="checkbox">
								<label for="champion48"><img data-id="48" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/48.png"/></label>
													<input id="champion50" class="champion_checkbox" type="checkbox">
								<label for="champion50"><img data-id="50" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/50.png"/></label>
													<input id="champion51" class="champion_checkbox" type="checkbox">
								<label for="champion51"><img data-id="51" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/51.png"/></label>
													<input id="champion53" class="champion_checkbox" type="checkbox">
								<label for="champion53"><img data-id="53" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/53.png"/></label>
													<input id="champion54" class="champion_checkbox" type="checkbox">
								<label for="champion54"><img data-id="54" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/54.png"/></label>
													<input id="champion55" class="champion_checkbox" type="checkbox">
								<label for="champion55"><img data-id="55" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/55.png"/></label>
													<input id="champion56" class="champion_checkbox" type="checkbox">
								<label for="champion56"><img data-id="56" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/56.png"/></label>
													<input id="champion57" class="champion_checkbox" type="checkbox">
								<label for="champion57"><img data-id="57" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/57.png"/></label>
													<input id="champion58" class="champion_checkbox" type="checkbox">
								<label for="champion58"><img data-id="58" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/58.png"/></label>
													<input id="champion59" class="champion_checkbox" type="checkbox">
								<label for="champion59"><img data-id="59" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/59.png"/></label>
													<input id="champion60" class="champion_checkbox" type="checkbox">
								<label for="champion60"><img data-id="60" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/60.png"/></label>
													<input id="champion61" class="champion_checkbox" type="checkbox">
								<label for="champion61"><img data-id="61" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/61.png"/></label>
													<input id="champion62" class="champion_checkbox" type="checkbox">
								<label for="champion62"><img data-id="62" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/62.png"/></label>
													<input id="champion63" class="champion_checkbox" type="checkbox">
								<label for="champion63"><img data-id="63" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/63.png"/></label>
													<input id="champion64" class="champion_checkbox" type="checkbox">
								<label for="champion64"><img data-id="64" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/64.png"/></label>
													<input id="champion67" class="champion_checkbox" type="checkbox">
								<label for="champion67"><img data-id="67" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/67.png"/></label>
													<input id="champion68" class="champion_checkbox" type="checkbox">
								<label for="champion68"><img data-id="68" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/68.png"/></label>
													<input id="champion69" class="champion_checkbox" type="checkbox">
								<label for="champion69"><img data-id="69" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/69.png"/></label>
													<input id="champion72" class="champion_checkbox" type="checkbox">
								<label for="champion72"><img data-id="72" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/72.png"/></label>
													<input id="champion74" class="champion_checkbox" type="checkbox">
								<label for="champion74"><img data-id="74" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/74.png"/></label>
													<input id="champion75" class="champion_checkbox" type="checkbox">
								<label for="champion75"><img data-id="75" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/75.png"/></label>
													<input id="champion76" class="champion_checkbox" type="checkbox">
								<label for="champion76"><img data-id="76" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/76.png"/></label>
													<input id="champion77" class="champion_checkbox" type="checkbox">
								<label for="champion77"><img data-id="77" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/77.png"/></label>
													<input id="champion78" class="champion_checkbox" type="checkbox">
								<label for="champion78"><img data-id="78" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/78.png"/></label>
													<input id="champion79" class="champion_checkbox" type="checkbox">
								<label for="champion79"><img data-id="79" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/79.png"/></label>
													<input id="champion80" class="champion_checkbox" type="checkbox">
								<label for="champion80"><img data-id="80" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/80.png"/></label>
													<input id="champion81" class="champion_checkbox" type="checkbox">
								<label for="champion81"><img data-id="81" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/81.png"/></label>
													<input id="champion82" class="champion_checkbox" type="checkbox">
								<label for="champion82"><img data-id="82" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/82.png"/></label>
													<input id="champion83" class="champion_checkbox" type="checkbox">
								<label for="champion83"><img data-id="83" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/83.png"/></label>
													<input id="champion84" class="champion_checkbox" type="checkbox">
								<label for="champion84"><img data-id="84" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/84.png"/></label>
													<input id="champion85" class="champion_checkbox" type="checkbox">
								<label for="champion85"><img data-id="85" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/85.png"/></label>
													<input id="champion86" class="champion_checkbox" type="checkbox">
								<label for="champion86"><img data-id="86" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/86.png"/></label>
													<input id="champion89" class="champion_checkbox" type="checkbox">
								<label for="champion89"><img data-id="89" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/89.png"/></label>
													<input id="champion90" class="champion_checkbox" type="checkbox">
								<label for="champion90"><img data-id="90" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/90.png"/></label>
													<input id="champion91" class="champion_checkbox" type="checkbox">
								<label for="champion91"><img data-id="91" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/91.png"/></label>
													<input id="champion92" class="champion_checkbox" type="checkbox">
								<label for="champion92"><img data-id="92" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/92.png"/></label>
													<input id="champion96" class="champion_checkbox" type="checkbox">
								<label for="champion96"><img data-id="96" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/96.png"/></label>
													<input id="champion98" class="champion_checkbox" type="checkbox">
								<label for="champion98"><img data-id="98" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/98.png"/></label>
													<input id="champion99" class="champion_checkbox" type="checkbox">
								<label for="champion99"><img data-id="99" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/99.png"/></label>
													<input id="champion101" class="champion_checkbox" type="checkbox">
								<label for="champion101"><img data-id="101" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/101.png"/></label>
													<input id="champion102" class="champion_checkbox" type="checkbox">
								<label for="champion102"><img data-id="102" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/102.png"/></label>
													<input id="champion103" class="champion_checkbox" type="checkbox">
								<label for="champion103"><img data-id="103" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/103.png"/></label>
													<input id="champion104" class="champion_checkbox" type="checkbox">
								<label for="champion104"><img data-id="104" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/104.png"/></label>
													<input id="champion105" class="champion_checkbox" type="checkbox">
								<label for="champion105"><img data-id="105" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/105.png"/></label>
													<input id="champion106" class="champion_checkbox" type="checkbox">
								<label for="champion106"><img data-id="106" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/106.png"/></label>
													<input id="champion107" class="champion_checkbox" type="checkbox">
								<label for="champion107"><img data-id="107" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/107.png"/></label>
													<input id="champion110" class="champion_checkbox" type="checkbox">
								<label for="champion110"><img data-id="110" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/110.png"/></label>
													<input id="champion111" class="champion_checkbox" type="checkbox">
								<label for="champion111"><img data-id="111" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/111.png"/></label>
													<input id="champion112" class="champion_checkbox" type="checkbox">
								<label for="champion112"><img data-id="112" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/112.png"/></label>
													<input id="champion113" class="champion_checkbox" type="checkbox">
								<label for="champion113"><img data-id="113" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/113.png"/></label>
													<input id="champion114" class="champion_checkbox" type="checkbox">
								<label for="champion114"><img data-id="114" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/114.png"/></label>
													<input id="champion115" class="champion_checkbox" type="checkbox">
								<label for="champion115"><img data-id="115" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/115.png"/></label>
													<input id="champion117" class="champion_checkbox" type="checkbox">
								<label for="champion117"><img data-id="117" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/117.png"/></label>
													<input id="champion119" class="champion_checkbox" type="checkbox">
								<label for="champion119"><img data-id="119" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/119.png"/></label>
													<input id="champion120" class="champion_checkbox" type="checkbox">
								<label for="champion120"><img data-id="120" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/120.png"/></label>
													<input id="champion121" class="champion_checkbox" type="checkbox">
								<label for="champion121"><img data-id="121" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/121.png"/></label>
													<input id="champion122" class="champion_checkbox" type="checkbox">
								<label for="champion122"><img data-id="122" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/122.png"/></label>
													<input id="champion126" class="champion_checkbox" type="checkbox">
								<label for="champion126"><img data-id="126" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/126.png"/></label>
													<input id="champion127" class="champion_checkbox" type="checkbox">
								<label for="champion127"><img data-id="127" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/127.png"/></label>
													<input id="champion131" class="champion_checkbox" type="checkbox">
								<label for="champion131"><img data-id="131" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/131.png"/></label>
													<input id="champion133" class="champion_checkbox" type="checkbox">
								<label for="champion133"><img data-id="133" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/133.png"/></label>
													<input id="champion134" class="champion_checkbox" type="checkbox">
								<label for="champion134"><img data-id="134" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/134.png"/></label>
													<input id="champion136" class="champion_checkbox" type="checkbox">
								<label for="champion136"><img data-id="136" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/136.png"/></label>
													<input id="champion143" class="champion_checkbox" type="checkbox">
								<label for="champion143"><img data-id="143" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/143.png"/></label>
													<input id="champion150" class="champion_checkbox" type="checkbox">
								<label for="champion150"><img data-id="150" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/150.png"/></label>
													<input id="champion154" class="champion_checkbox" type="checkbox">
								<label for="champion154"><img data-id="154" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/154.png"/></label>
													<input id="champion157" class="champion_checkbox" type="checkbox">
								<label for="champion157"><img data-id="157" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/157.png"/></label>
													<input id="champion161" class="champion_checkbox" type="checkbox">
								<label for="champion161"><img data-id="161" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/161.png"/></label>
													<input id="champion163" class="champion_checkbox" type="checkbox">
								<label for="champion163"><img data-id="163" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/163.png"/></label>
													<input id="champion201" class="champion_checkbox" type="checkbox">
								<label for="champion201"><img data-id="201" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/201.png"/></label>
													<input id="champion202" class="champion_checkbox" type="checkbox">
								<label for="champion202"><img data-id="202" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/202.png"/></label>
													<input id="champion203" class="champion_checkbox" type="checkbox">
								<label for="champion203"><img data-id="203" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/203.png"/></label>
													<input id="champion222" class="champion_checkbox" type="checkbox">
								<label for="champion222"><img data-id="222" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/222.png"/></label>
													<input id="champion223" class="champion_checkbox" type="checkbox">
								<label for="champion223"><img data-id="223" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/223.png"/></label>
													<input id="champion236" class="champion_checkbox" type="checkbox">
								<label for="champion236"><img data-id="236" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/236.png"/></label>
													<input id="champion238" class="champion_checkbox" type="checkbox">
								<label for="champion238"><img data-id="238" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/238.png"/></label>
													<input id="champion245" class="champion_checkbox" type="checkbox">
								<label for="champion245"><img data-id="245" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/245.png"/></label>
													<input id="champion254" class="champion_checkbox" type="checkbox">
								<label for="champion254"><img data-id="254" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/254.png"/></label>
													<input id="champion266" class="champion_checkbox" type="checkbox">
								<label for="champion266"><img data-id="266" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/266.png"/></label>
													<input id="champion267" class="champion_checkbox" type="checkbox">
								<label for="champion267"><img data-id="267" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/267.png"/></label>
													<input id="champion268" class="champion_checkbox" type="checkbox">
								<label for="champion268"><img data-id="268" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/268.png"/></label>
													<input id="champion412" class="champion_checkbox" type="checkbox">
								<label for="champion412"><img data-id="412" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/412.png"/></label>
													<input id="champion420" class="champion_checkbox" type="checkbox">
								<label for="champion420"><img data-id="420" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/420.png"/></label>
													<input id="champion421" class="champion_checkbox" type="checkbox">
								<label for="champion421"><img data-id="421" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/421.png"/></label>
													<input id="champion429" class="champion_checkbox" type="checkbox">
								<label for="champion429"><img data-id="429" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/429.png"/></label>
													<input id="champion432" class="champion_checkbox" type="checkbox">
								<label for="champion432"><img data-id="432" class="champion_images" src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs42x42/432.png"/></label>
										  </fieldset>
...
<div id="advanced-sortables" class="meta-box-sortables"><div id="match_history_meta_box" class="postbox " >
<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Matches Played</span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class='hndle'><span>Matches Played</span></h2>
<div class="inside">
	<div class="match-history">
		<table class="match-history-table widefat fixed tablesorter">
			...
			<tbody>
				            						<tr class="matches_tr match_id_1 lost">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/7.png" alt="champion image" width="60"/></td>
							<td><div class="result">Defeat</div>
							<span title="10/03/2016 9:11 PM"> 1 hour ago</span>
							</td>
							<td>5/3/5</td>
							<td>8,123</td>
							<td>140</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1056.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3802.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3020.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3001.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3089.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1052.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3340.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_2 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/7.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="10/01/2016 7:05 PM"> 2 hours ago</span>
							</td>
							<td>13/3/14</td>
							<td>14,541</td>
							<td>204</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1056.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3001.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3089.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3165.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1058.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3020.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_3 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/7.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="10/01/2016 6:00 PM"> 2 hours ago</span>
							</td>
							<td>12/3/6</td>
							<td>12,062</td>
							<td>161</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1056.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3165.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3001.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3020.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1082.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1058.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_4 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/58.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="10/01/2016 5:01 PM"> 3 hours ago</span>
							</td>
							<td>5/0/2</td>
							<td>9,325</td>
							<td>221</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3071.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3074.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1031.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1055.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_5 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/58.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="10/01/2016 4:09 PM"> 5 hours ago</span>
							</td>
							<td>8/2/5</td>
							<td>14,812</td>
							<td>240</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1055.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3071.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3812.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1011.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3053.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3047.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_6 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/48.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="10/01/2016 3:33 PM"> 2 weeks ago</span>
							</td>
							<td>6/4/9</td>
							<td>9275</td>
							<td>110</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3057.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3143.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3748.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_7 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/25.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/30/2016 6:22 PM"> 2 weeks ago</span>
							</td>
							<td>3/5/20</td>
							<td>7385</td>
							<td>17</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3092.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3190.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2049.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1052.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3158.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_8 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/25.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/30/2016 5:47 PM"> 2 weeks ago</span>
							</td>
							<td>3/3/25</td>
							<td>9100</td>
							<td>5</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3191.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3092.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3190.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2049.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3108.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3158.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_9 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/25.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/30/2016 5:13 PM"> 2 weeks ago</span>
							</td>
							<td>2/8/21</td>
							<td>9150</td>
							<td>13</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3190.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3191.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3092.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2049.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3108.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3158.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/14.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_10 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/30/2016 4:29 PM"> 2 weeks ago</span>
							</td>
							<td>2/2/1</td>
							<td>5483</td>
							<td>150</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_11 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/30/2016 4:00 PM"> 2 weeks ago</span>
							</td>
							<td>8/5/8</td>
							<td>14458</td>
							<td>230</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3026.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3153.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3742.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1036.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_12 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/104.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/29/2016 1:29 AM"> 2 weeks ago</span>
							</td>
							<td>4/2/8</td>
							<td>7300</td>
							<td>98</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1412.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3006.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3142.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/11.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_13 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/29/2016 12:59 AM"> 2 weeks ago</span>
							</td>
							<td>5/5/4</td>
							<td>10158</td>
							<td>168</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1036.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1011.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3147.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_14 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/29/2016 12:24 AM"> 2 weeks ago</span>
							</td>
							<td>11/2/7</td>
							<td>8308</td>
							<td>115</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3147.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1033.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1001.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_15 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/28/2016 11:52 PM"> 2 weeks ago</span>
							</td>
							<td>4/2/2</td>
							<td>9358</td>
							<td>159</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2043.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3153.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1028.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_16 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/28/2016 11:24 PM"> 2 weeks ago</span>
							</td>
							<td>8/0/4</td>
							<td>9283</td>
							<td>151</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1028.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2043.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2033.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3147.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_17 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/39.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/28/2016 10:53 PM"> 2 weeks ago</span>
							</td>
							<td>12/3/5</td>
							<td>14258</td>
							<td>251</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3078.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3742.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1038.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3153.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3134.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/12.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_18 lost">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/89.png" alt="champion image" width="60"/></td>
							<td><div class="result">Defeat</div>
							<span title="09/28/2016 9:25 PM"> 2 weeks ago</span>
							</td>
							<td>3/7/15</td>
							<td>12000</td>
							<td>42</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3401.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2049.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3190.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3024.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3082.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/3.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_19 lost">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/89.png" alt="champion image" width="60"/></td>
							<td><div class="result">Defeat</div>
							<span title="09/28/2016 8:12 PM"> 2 weeks ago</span>
							</td>
							<td>2/5/3</td>
							<td>6675</td>
							<td>51</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3401.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2049.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3024.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3111.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3082.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/2043.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3364.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/3.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						            						...
						            						<tr class="matches_tr match_id_20 lost">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/29.png" alt="champion image" width="60"/></td>
							<td><div class="result">Defeat</div>
							<span title="09/28/2016 6:27 PM"> 2 weeks ago</span>
							</td>
							<td>2/7/5</td>
							<td>8550</td>
							<td>159</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3142.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3006.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3085.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1053.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1055.png" width="30" alt="items-5"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3363.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/7.png" alt="spell2 image" width="30"/>
							</td>
							<td>							</td>
						</tr>
						            						<tr class="matches_tr match_id_21 win">
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/champs60x60/51.png" alt="champion image" width="60"/></td>
							<td><div class="result">Victory</div>
							<span title="09/28/2016 1:19 AM"> 2 weeks ago</span>
							</td>
							<td>5/3/7</td>
							<td>8750</td>
							<td>167</td>
							<td><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3031.png" width="30" alt="items-0"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3006.png" width="30" alt="items-1"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3085.png" width="30" alt="items-2"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1053.png" width="30" alt="items-3"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/1055.png" width="30" alt="items-4"/><img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/items30x30/3340.png" width="30" alt="items-6"/></td>
							<td>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/4.png" alt="spell1 image" width="30"/>
								<img src="http://ieloboost.com/wp-content/themes/leagueboost/assets/img/summonersspell30x30/7.png" alt="spell2 image" width="30"/>
							</td>
					...
					<div class="match_stat">Total <strong>21</strong> matches have been played.</div> <span>(Updated every <strong>180 seconds</strong>)</span>
						<ul class="matches_pagination pagination" role="navigation" aria-label="Pagination">
									<li class="current"><a href="javascript:paginateMatches(1);">1</a></li>
									<li ><a href="javascript:paginateMatches(2);">2</a></li>
									<li ><a href="javascript:paginateMatches(3);">3</a></li>
									<li ><a href="javascript:paginateMatches(4);">4</a></li>
									<li ><a href="javascript:paginateMatches(5);">5</a></li>
							</ul>

			 </div>
</div>
</div><div id="advanced-sortables" class="meta-box-sortables"><div id="order_history_meta_box" class="postbox " >
<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">Toggle panel: All Order History</span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class='hndle'><span>All Order History</span></h2>
<div class="inside">
	<div class="boosting-orders">
		<table class="boosting-orders-table widefat fixed tablesorter">
			...
			<tbody>
										<tr>
							<td>Solo Boost from Gold IV to PLatinum II</td>
							<td>Solo Division</td>
							<td></td>
							<td>*</td>
							<td>Pending</td>
							<td><a href='http://ieloboost.com/wp-admin/admin.php?page=my-dashboard&order=750'>More</a></td>
						</tr>
							</tbody>
		</table>
	</div>
	...
	<!-- ================ Start Sidebar ================ -->
	<div id="sidebar">
		<div id="advanced-sortables" class="meta-box-sortables"><div id="current_order_standings_meta_box" class="postbox " >
<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Current Order Standing</span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class='hndle'><span>Current Order Standing</span></h2>
<div class="inside">
<div class="boosting_name">Solo Boost from Gold IV to Platinum II</div>		<div class="order_start_block standing_block three_col">
			<div class="title">Start</div>
			<div class="order_start_details">
				<img class="img-responsive" id="start-image" width="100" src="
					http://ieloboost.com/wp-content/themes/leagueboost/assets/img/divisions/3_2.png" />
				<div class="order_name">Gold<br>Division IV<br>LP: 60</div>
			</div>
		</div>
		<div class="order_current_block standing_block three_col">
			...
			<div class="order_current_details">
				<img class="img-responsive" id="current-image" width="100" src="
					http://ieloboost.com/wp-content/themes/leagueboost/assets/img/divisions/4_1.png" />
				<div class="order_name">Platinum<br>Division V<br>LP: 0</div>
			</div>
		</div>
		<div class="order_desired_block standing_block three_col">
			...
			<div class="order_desired_details">
				<img class="img-responsive" id="desired-image" width="100" src="
					http://ieloboost.com/wp-content/themes/leagueboost/assets/img/divisions/4_4.png" />
				<div class="order_name">Platinum<br>Division II</div>
			</div>
		</div>
		</div>
</div>
</div><div id="advanced-sortables" class="meta-box-sortables"><div id="send_message_meta_box" class="postbox " >
<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Message Box</span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class='hndle'><span>Message Box</span></h2>
<div class="inside">
		<div class="main-message">
		<ul class="tabs" data-tabs id="message-users-tab">
	  			  <li class="tabs-title  is-active"><a href="#admin">Booster</a></li>
		</ul>
		<div class="tabs-content" data-tabs-content="message-users-tab">
		  <div class="tabs-panel  is-active" id="admin">
			<div class="message-history">
				<ul class="message-list">
										  <li class="message-other">
							<div class="message-head">
	  							<h4>Booster</h4>
									<span title="09/20/2016 5:51 PM">Just now </span>
							</div>
							...
							<div class="message-head">
	  							<h4>Booster</h4>
									<span title="10/09/2016 1:03 AM">Just now </span>
							</div>
							<div class="message-content"><p>I am gonna start right now. I will queue as mid / top</p>
</div>
						</li>
											  <li class="message-me">
							<div class="message-head">
	  							<h4>You</h4>
									<span title="10/09/2016 1:04 AM">6 days </span>
							</div>
							<div class="message-content"><p>Ok, could be possible for you to play lucian mid?</p>
</div>
						</li>
            <li class="message-other">
    <div class="message-head">
    ...
    <div class="message-content"><p>Ok will do next game!</p>
</div>
  </li>
									</ul>
			</div>
  			<div class="message-reply">
  				<div class="message-form">
  					<form action="" name="send_message" id="admin_message_form" method="POST" class="formatted-form"  accept-charset="utf-8">
  					  ...
  					  <input type="hidden" name="user_recipient" value="1" />
					  <input type="hidden" name="user_action" value="send_message" />
  					  <input type="hidden" name="order_in_progress" value="750" />
...
<script type='text/javascript'>
/* <![CDATA[ */
var commonL10n = {"warnDelete":"You are about to permanently delete these items.\n  'Cancel' to stop, 'OK' to delete.","dismiss":"Dismiss this notice."};var heartbeatSettings = {"nonce":"5c3d0edb82"};var authcheckL10n = {"beforeunload":"Your session has expired. You can log in again from this page or go to the login page.","interval":"180"};var wpAjax = {"noPerm":"Sorry, you are not allowed to do that.","broken":"An unidentified error has occurred."};var postBoxL10n = {"postBoxEmptyString":"Drag boxes here"};var tagsBoxL10n = {"tagDelimiter":","};var wordCountL10n = {"type":"words","shortcodes":["embed","wp_caption","caption","gallery","playlist","audio","video","nf_preview","ninja_form","ninja_forms","ninja_forms_display_form","acf"]};var postL10n = {"ok":"OK","cancel":"Cancel","publishOn":"Publish on:","publishOnFuture":"Schedule for:","publishOnPast":"Published on:","dateFormat":"%1$s %2$s, %3$s @ %4$s:%5$s","showcomm":"Show more comments","endcomm":"No more comments found.","publish":"Publish","schedule":"Schedule","update":"Update","savePending":"Save as Pending","saveDraft":"Save Draft","private":"Private","public":"Public","publicSticky":"Public, Sticky","password":"Password Protected","privatelyPublished":"Privately Published","published":"Published","saveAlert":"The changes you made will be lost if you navigate away from this page.","savingText":"Saving Draft\u2026","permalinkSaved":"Permalink saved"};/* ]]> */
</script>
<script type='text/javascript' src='http://ieloboost.com/wp-content/themes/leagueboost/admin/js-scripts.js?ver=4.6.1'></script>
