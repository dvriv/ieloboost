<?php
/**
 * Template Name: Group Games (Normals)
 *
...
<div id="primary" class="content-area">
    <div class="page-description">
        <div class="wrap">
            <h1>Duo Games</h1>
            <span>Play ranked games with the booster without a guaranteed number of wins</span>
        </div>
    </div>
    <main id="main" class="site-main" role="main">
                <div class="row form-container">
                    <form action="<?php echo home_url('/boosting-purchase');?>" method="POST" class="booster_payement_form" id="solo_division_form" name="solo_division_form">
                        ...
                        <div class="medium-6 small-12 columns desiredColumns">
                            <div class="medium-12 small-12 large-12 columns">
                                ...
                                <div id="general-wins_stat" class="slider_stat stat"></div>
                            </div>
                            <input type="hidden" id="to_league" value=""/>
                            <input type="hidden" id="to_division" value=""/>
                            <fieldset>
                                <label for="number_of_winsLabel" class="medium-2 control-label columns">Number of Group Games</label>
                                <div class="medium-10 columns">
                    ...
                    <span> This a Duo Division Boost. This mean you have to play with the booster in Duo Queue. If you want the booster to play on your account, please <a href="/solo-normal-wins">go to the Solo version of the same boost here</a></span>
                ...
                <section class="bQuestions">
                  ...
                  <div class="row rowQuestions">
                            <div class="question-container">
                              <h2>What is a Games Boost?</h2>
                              <p>You will play games with one of our boosters, without a guaranteed division boost or number of wins. While an improvement in your rank is not guaranteed, our booster will play their best and most of the times a greater increase in your rank is achieved because of the awesome win ratio our booster always have.</p>                            </div>
                            <div class="question-container">
                            ...
                            <div class="question-container">
                              ...
                              <p>Yes, you are free to play while the booster is not available, but try to not play without the booster if he is online and ready to play.</p>
                            </div>
                            <div class="question-container">
