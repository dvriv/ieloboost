...
<div id="primary" class="content-area">
    <div class="page-description">
        <div class="wrap">
            <h1>Duo Net Wins </h1>
            <span>We will play with you the amout of positive wins you desire</span>
        </div>
    </div>
    <main id="main" class="site-main" role="main">
                <div class="row form-container">
                    ...
                    <span> This is a Duo Division Boost. This mean you have to play with the booster in Duo Queue. If you want the booster to play on your account, please <a href="/solo-net-wins">go to the Solo version of the same boost here</a></span>
                ...
                <section class="bQuestions">
                  ...
                  <div class="row rowQuestions">
                            <div class="question-container">
                              <h2>What is a Net Wins Boost?</h2>
